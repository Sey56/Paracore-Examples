# Paracore Parameter Engine

The Paracore Parameter Engine is a **convention-based, zero-boilerplate** system. It generates rich UIs by inspecting your C# `Params` class, supporting native types, validation, and dynamic logic.
